...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student("Mevsha", "Sergei", 17, "bookkeeping", 3);
		Student student2 = new Student("Aksenova", "Diana", 23, "bookkeeping", 3);
		Student student3 = new Student("Lupanov", "Roman", 18, "bookkeeping", 3);
		Student student4 = new Student("Sahapov", "Evgeny", 26, "bookkeeping", 3);
		Student student5 = new Student("Sharonova", "Irina", 18, "bookkeeping", 3);
		Student student6 = new Student("Markov", "Sergei", 16, "bookkeeping", 3);
		...
		Student student10 = new Student("Antonova", "Marina", 12, "bookkeeping", 3);
		...
		try {
			...
			groupOne.interectivSetStudents();
			groupOne.interectivSetStudents();
			groupOne.interectivSetStudents();
		...
		System.out.println(groupOne.toString());
		Student[] rookies ;
		rookies=groupOne.getRookies();
		for (Student student : rookies) {
